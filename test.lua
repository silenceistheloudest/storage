local content = game:HttpGet("https://github.com/linemaster2/storage/blob/main/proggyclean.ttf?raw=true");

if not isfolder("judensense") then
makefolder("judensense");
end;

if not isfile("judensense/proggyclean.ttf") then
writefile("judensense/proggyclean.ttf", content);
end;

--// not made by me
local HttpService = game:GetService("HttpService");

writefile("judensense/font.ttf", HttpService:JSONEncode({
["name"] = "silk",
["faces"] = {
{
["name"] = "Regular",
["weight"] = 100,
["style"] = "normal",
["assetId"] = getcustomasset("judensense/proggyclean.ttf")
}
}
}))

local FontObject = Font.new(getcustomasset("judensense/font.ttf"), Enum.FontWeight.Regular, Enum.FontStyle.Normal)

delfile("judensense/font.ttf")
...
elseif drawingType == "Square" then
    local squareObj = ({
        ...
        GradientRotation = 0,
        GradientColor1 = Color3.new(1, 1, 1),
        GradientColor2 = Color3.new(0, 0, 0)
    } + baseDrawingObj)
    ...
    if squareObj.GradientEnabled then
        uiGradient.Rotation = squareObj.GradientRotation
        uiGradient.Color = ColorSequence.new(squareObj.GradientColor1, squareObj.GradientColor2)
        uiGradient.Parent = squareFrame
    end
    ...
    return setmetatable(table.create(0), {
        __newindex = function(_, index, value)
            ...
            elseif index == "GradientEnabled" then
                if value then
                    uiGradient.Rotation = squareObj.GradientRotation
                    uiGradient.Color = ColorSequence.new(squareObj.GradientColor1, squareObj.GradientColor2)
                    uiGradient.Parent = squareFrame
            ...
            elseif index == "GradientRotation" then
                uiGradient.Rotation = value
            elseif index == "GradientColor1" then
                uiGradient.Color = ColorSequence.new(value, squareObj.GradientColor2)
            elseif index == "GradientColor2" then
                uiGradient.Color = ColorSequence.new(squareObj.GradientColor1, value)
            end
